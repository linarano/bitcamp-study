...
public class Exam0112 {
  public static void main(String[] args) {
    ...
    class Score { //아직 변수가 존재하는게 아니라 설계도일뿐. , 메인메소드안에 정의 - 메인메소드만 사용가능
      String name;
      int kor;
      int eng;
      int math;
...
//
// 배열(array)
// - 단일한 타입의 메모리를 묶는 문법이다. ( 배열은 단일타입이며, 메소드를 못묶으므로, 실무에서는 class 많이쓴다.)
//
...
//   예) Score s = new Score();
//       s.name = "홍길동";
// Score s;   s.name = "홍길동";NullPointerException - 주소가 없으니 찾아갈수가 없다.
//
