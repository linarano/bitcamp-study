...
public class Exam0130 {
  ...
  public static void main(String[] args) {
    ...
    //     Score.calculate(score); 클래스명.메서드명(파라미터-인스턴스주소);
    ...
    s.calculate(); // 변수 뒤에 연산자를 놓는 i++ 의 예와 비슷하다. //인스턴스 주소를 파라미터.calculate();
...
// 클래스명.메서드명();
//
// - 다음과 같이 레퍼런스를 통해서도 호출할 수 있다. - 클래스메서드는 클래스명으로 호출해라.
// 레퍼런스.메서드명();
