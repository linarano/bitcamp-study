...
public class Exam0210 {
  ...
  static class B2 extends B {
    // 오버라이딩 문법
    // => 메서드명, 파라미터 형식, 리턴 타입이 같아야 한다.(메서드시그니처)
    // => 파라미터의 이름은 달라도 된다. 상관없다.
    //
    void m(float x) { //파라미터의 타입을 다르게 했으므로 오버로딩
  ...
  public static void main(String[] args) {
    ...
    obj.m(3.14f); // B2의 m(float) 메서드를 호출 // 두 메서드는 전혀 다른 메서드 - 메서드 시그니처가 같아야함

    // 해결책?
    // => 개발자들의 이런 실수가 많이 발생해서 자바에서는
    //    오버라이딩 여부를 검사하는 특별한 문법을 추가하였다. => 실수가 잦았다는 의미 
    // 안전장치를 해야한다. 실수와 부주의는 다른 것.
    //
  }
}
