...
public class Exam0152 {
  ...
  public static void main(String[] args) {
    ...
    MyKey k1 = new MyKey("ok"); //객체의 주소 
    MyKey k2 = new MyKey("no");
    MyKey k3 = new MyKey("haha");
    MyKey k4 = new MyKey("ohora");
    MyKey k5 = new MyKey("hul");

    map.put(k1, new Student("홍길동", 20, false));//객체의 주소(직관적으로 객체라고 표현)를 key로 저장 , 저장할 값
...
//해쉬셋은 해쉬번호로 저장 (라인이 5개있으면 - 5로나눈 나머지에 따라 저장)
//해시맵 
