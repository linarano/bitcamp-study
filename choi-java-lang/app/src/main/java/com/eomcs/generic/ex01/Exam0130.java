...
public class Exam0130 {
  ...
  //    <다루는 타입의 별명>  리턴타입_별명 메서드명(다루는_타입_별명 파라미터, ...) {...}
  ...
  //
  static <What> What echo(What obj) { //    변수명이다 인터페이스나 클래스이름 아니다 => 컴파일러야 타입파라미터야 : 넘어오는 값에 따라 결정
    return obj;
  } // 한개의 범용 메서드로 다양한 타입에 대해서 대응할 수 있다. 
