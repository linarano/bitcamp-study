...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //    ...
    //    이런 식으로 문자열을 Base64로 바꾸면 결과는 다음과 같다. //이거는 문자열=>문자열 네트워크장비를 통과할때 8비트가 통과안되는 경우 있음, 네트워킹프로그램 iso-8859 7비트 => 짤리는 경우가 있으므로, base64: 8비트=>7비트로 바꿔서 사용하는 경우도있음 
