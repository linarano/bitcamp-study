...
// - 그래서 RuntimeException 계열의 예외를 uncheck Exception 이라고 부른다.
//
// DAO 객체에서 예외 상황이 발생했을 떄 그 예외를 다루기 쉽도록 RuntimeException 에 담아
// 호출자에게 던지는 것이 유지보수에 편하다.
//
public class DaoException extends RuntimeException {
  private static final long serialVersionUID = 6932348239921088297L;
