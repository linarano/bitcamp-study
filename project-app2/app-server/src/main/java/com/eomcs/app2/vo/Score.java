...
/*
public class Score implements Serializable{ // 객체를 자동으로 바이트 배열로 만들려면 -> 시리얼라이져블 허락해줘야함**
  private static final long serialVersionUID = 1L; // 객체를 자동으로 바이트 배열로 만들려면 -> 시리얼라이져블 허락해줘야함
