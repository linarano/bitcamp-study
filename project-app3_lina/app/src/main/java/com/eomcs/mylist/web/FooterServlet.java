...
public class FooterServlet extends HttpServlet {
  ...
  @Override
  protected void service (HttpServletRequest req, HttpServletResponse resp) //footer에 들어갈 내용만 출력
      throws ServletException, IOException {
    // GET,POST 요청 모두에 대응할 수 있도록 service() 를 오버라이딩한다.
    // 요청을 따로 처리하게 싶으면   doGet() 따로 정의 
